...
const (
	SimpleService_SendMessage_FullMethodName = "/simple.SimpleService/SendMessage"
)
...
type SimpleServiceClient interface {
	SendMessage(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error)
}
...
func (c *simpleServiceClient) SendMessage(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SimpleResponse)
	err := c.cc.Invoke(ctx, SimpleService_SendMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SimpleServiceServer interface {
	SendMessage(context.Context, *SimpleRequest) (*SimpleResponse, error)
...
func (UnimplementedSimpleServiceServer) SendMessage(context.Context, *SimpleRequest) (*SimpleResponse, error) {
...
func _SimpleService_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SimpleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimpleServiceServer).SendMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SimpleService_SendMessage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleServiceServer).SendMessage(ctx, req.(*SimpleRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _SimpleService_SendMessage_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "simple_hello.proto",
}
